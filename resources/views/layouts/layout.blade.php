...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar accordion" id="accordionSidebar" style="background: #161e65; color:#fff;">

            <!-- Sidebar - Brand -->
            <a class="sidebar-brand text-white d-flex align-items-center justify-content-center" href="#">
                <div class="sidebar-brand-icon rotate-n-0">
                    {{-- <img src="{{ asset('asset/img/pens.jpg') }}" width="60" height="60"> --}}
                </div>
                <div class="sidebar-brand-text mx-2">PENS</div>
            </a>
